...
We tested on Ubuntu 18.04. We tried compiling the CUDA renderer on Ubuntu 16.04, but it didn't work. It is recommended to run on Ubuntu 18.04 or use Docker.
## Installation
